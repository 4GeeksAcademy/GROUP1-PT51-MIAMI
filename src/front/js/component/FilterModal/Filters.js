            ...
            <div className="modal-body">
              <div className="carPriceContainer">
                <div className="d-flex justify-content-center">
                  <input onChange={handleRange} type="range" min="8000" max="100000" value={rangeValue} step="500" />
                </div>
                <div className="d-flex justify-content-center" style={{ paddingBottom: '20px' }}>
                  <h5>$</h5><input onChange={handleRange} value={rangeValue} />
